...
void APSLK_LED_Init(void)
{  
  DDRB_BIT4 = 1;  //Enable as Output (LED4)
  DDRB_BIT5 = 1;  //Enable as Output (LED3)
  DDRB_BIT6 = 1;  //Enable as Output (LED2)
  DDRB_BIT7 = 1;  //Enable as Output (LED1)
  PUCR_PUPBE = 1; 
}
/************************************************************************************************/
