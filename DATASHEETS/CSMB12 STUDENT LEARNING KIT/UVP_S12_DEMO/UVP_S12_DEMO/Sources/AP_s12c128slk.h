/*
 * File:        AP_s12c128slk.h
 * Purpose:     S12SLK definitions that map to the APS12C128SLK I/O interfaces
 *
 * Notes:
 */
...
#define SLK_POT  ATDDR5H             //Direct Connect to PTAD_PTAD1 also ATD Ch.1

/* SLK SCI Registers for the S12C128 Module*/
...
/* SLK LCD Registers for the S12C128 Module*/
...
#define SLK_BUZZER_VOLUME TC0Lo  //Not Implemented
