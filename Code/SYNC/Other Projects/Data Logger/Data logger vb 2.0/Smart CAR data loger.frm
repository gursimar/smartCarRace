...
Dim Comarray(8) As Integer
Dim Error_com As Integer
...
Private Sub Form_Load()
   ...
   ' Get a new workbook.
      ...
      oSheet.Cells(1, 8).Value = "Sensor 0"
        ...
        'COMPENSATTION
      oSheet.Cells(1, 10).Value = "Sensor 7"
      oSheet.Cells(1, 11).Value = "Sensor 6"
      oSheet.Cells(1, 12).Value = "Sensor 5"
      oSheet.Cells(1, 13).Value = "Sensor 4"
      oSheet.Cells(1, 14).Value = "Sensor 3"
      oSheet.Cells(1, 15).Value = "Sensor 2"
      oSheet.Cells(1, 16).Value = "Sensor 1"
      oSheet.Cells(1, 17).Value = "Sensor 0"
      
      'ERROR
      oSheet.Cells(1, 19).Value = "Error"
...
'    DoEvents
    ...
    For j = 0 To 2
        ...
        Data(j) = Mid(RichTextBox1.Text, Startdata + 1, Enddata - Startdata - 1)
        ...
        If j = 0 Then
            For i = 0 To 7
                Senarray(i) = Mid(Data(0), start + 1, 3)
                start = start + 6
                'MsgBox Senarray(i)
            Next
        ...
        ElseIf j = 1 Then
            ...
            For i = 0 To 7
                Comarray(i) = Mid(Data(1), start + 1, 3)
                start = start + 6
                'MsgBox Senarray(i)
            Next
...
Private Sub FillWorkbook()
 ...
 '     DoEvents
      ...
      oRng.Value = Senarray
      Set oRng = oSheet.Range("J" & CStr(NoData), "Q" & CStr(NoData))
 '     DoEvents
      oRng.Value = Comarray
        
      oSheet.Cells(NoData, 19).Value = Error_com
